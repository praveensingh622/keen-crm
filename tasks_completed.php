...
$sql_panel = "SELECT * FROM task WHERE status='completed'";
...
<a href="javascript:void(0);" class="dropdown-toggle" data-bs-toggle="dropdown">Revision Needed</a>
<div class="dropdown-menu  dropdown-menu-start">
<ul>
<li>
<a href="task.php">
<i class="ti ti-dots-vertical"></i>Revision Needed
</a>
</li>
<li>
<a href="task_working_on_it.php">
<i class="ti ti-dots-vertical"></i>Working On It
</a>
</li>
<li>
<a href="all_task.php">
...
$sql21 = "SELECT * FROM task  WHERE status='completed'";
