...
<input type="text" class="form-control" id="live_search" autocomplete="off" placeholder="Search Task">
</div>
</div>
...
<a href="javascript:void(0);" class="dropdown-toggle" data-bs-toggle="dropdown">Pending Tasks </a>
<div class="dropdown-menu  dropdown-menu-start">
<ul>
<li>
<a href="task.php">
<i class="ti ti-dots-vertical"></i>Pending Tasks
</a>
</li>
<li>
<a href="all_task.php">
<i class="ti ti-dots-vertical"></i>All Task
</a>
</li>
<li>
<a href="tasks_completed.php">
...
<?php
	$id = $_SESSION['user_id'];
$sql21 = "SELECT assign_task.task_ticket, assign_task.emp_id,task.priority, task.start_date, task.project_id, task.title, task.description, task.status FROM assign_task LEFT JOIN task ON assign_task.task_ticket = task.task_ticket WHERE assign_task.emp_id='$id'";
$result21 = mysqli_query($conn, $sql21);
$number_jobs = mysqli_num_rows($result21);
?>

<div class="task-wrapper">
<a href="#" class="task-accordion" data-bs-toggle="collapse" data-bs-target="#recent">
<h4>Recent<span><?=$number_jobs?></span></h4>
</a>
...
<span class="form-icon"><i class="ti ti-calendar-check"></i></span>
 <input type="text" id="startdate" class="form-control" name="start_date" placeholder="Select a start date">
<!-- <input type="text" id="datepicker" class="form-control" name="start_date" placeholder="Select a date"> -->
</div>
</div>
<div class="col-md-6">
...
<div class="form-wrap icon-form">
<span class="form-icon"><i class="ti ti-calendar-check"></i></span>
<input type="text" id="duedate" class="form-control" name="due_date" placeholder="Select a due date">
...
<script>
    $(function() {
      ...
      $('#duedate').daterangepicker({
        singleDatePicker: true,
        showDropdowns: true,
        minDate: moment(),  // Disable past dates initially
        locale: {
          format: 'YYYY-MM-DD'
        }
      });
      ...
      $('#startdate').on('apply.daterangepicker', function(ev, picker) {
        var startDate = picker.startDate; // Get the selected start date
        
        // Set the min date for Due Date to be the selected Start Date (or later)
        $('#duedate').daterangepicker({
          singleDatePicker: true,
          showDropdowns: true,
          minDate: startDate, // Set minDate as the selected start date
          locale: {
            format: 'YYYY-MM-DD'
          }
        });
