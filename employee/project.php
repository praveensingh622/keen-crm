...
<tbody>
	...
	<tr class="odd">
		...
		<td>
				...
				<a href="project-details.html" class="profile-split d-flex flex-column"><?= $row["project_name"]?></a>
			
		</td>
		<td>
			<h2 class="table-avatar d-flex align-items-center">
				
				<a href="company-details.html" class="profile-split d-flex flex-column"><?= $row["client_name"]?></a>
			</h2>
		</td>
		<td>
