...
<ul>
<li>
<a href="export_leads.php"><i class="ti ti-file-type-pdf text-danger"></i>Export as Excel</a>
</li>
<li>
...
<input type="text" class="form-control" name="leads_company_name" placeholder="Company Name">
</div>
</div>
<div class="col-md-6">
<div class="form-wrap">
