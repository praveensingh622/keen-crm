...
<ul>
<li>
<a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_role"><i class="ti ti-square-rounded-plus"></i>Add Task Category</a>
</li>
</ul>
</div>
</div>
...
<form action="php/task-category.php" method="POST">
<div class="form-wrap">
