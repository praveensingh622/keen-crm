...
$current_category = '';
$sql21 = "SELECT * FROM task WHERE project_id='$get_id' ORDER BY category";
...
// if (mysqli_num_rows($result)>0) {
	while ($row = mysqli_fetch_assoc($result21)) {
		 ...
		 if ($row['category'] != $current_category) {
            ...
            $category_name_change_for_id = str_replace(" ", "_", $current_category);
            ?>
<div class="task-wrapper">
	<a href="#" class="task-accordion" data-bs-toggle="collapse"
										data-bs-target="#<?=$category_name_change_for_id?>">
	 ...
	 ?>
	 <div class="tasks-activity tasks collapse show" id="<?=$category_name_change_for_id?>">
<ul>
...
<span class="badge badge-tag bg-pending"><?php echo $row["status"] ?></span><span class="badge badge-tag bg-pending"><?php echo $row["category"] ?></span>
</div>
