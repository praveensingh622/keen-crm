...
<img src="assets/img/keeninsite-logo-resize.webp" class="img-fluid" alt="Logo">
</div>
...
if (isset($_GET['status'])) {
	...
	if ($sa==402) {
	echo "<p style='text-align:center;color:red'>Your Account Is Suspended</p>";
	}
}
?>
<div class="login-social-link">
<div class="copyright-text">
<p>Copyright &copy;2024 - Keen Insites</p>
</div>
</div>
</div>
